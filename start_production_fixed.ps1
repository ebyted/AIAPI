# Script de inicio rápido para producción (PowerShell)

Write-Host "🚀 BeCalm API - Inicio Rápido de Producción" -ForegroundColor Green
...
Write-Host "📝 Logs se mostrarán a continuación" -ForegroundColor White
